...
export class UtilsApi {
    ...
    @Inject
    private checkSha256UtilTest: CheckSha256Util;
    ...
    @Path('/checkSha256')
    @Tags('potres2020')
    @Example<CheckSha256Request>({sha256Request:'sha256 from Ushahidi', webhookUrl: 'webhook url as defined in Ushahidi', payload: 'the payload which you received from Ushahidi'})
    ...
    public checkSha256(checkSha256Request: CheckSha256Request): Promise<CheckSha256Response> {
        return this.getSharedSecretForWebhookUrl(checkSha256Request.webhookUrl)
            .then(value => {
                ...
                return new CheckSha256Response(this.checkSha256UtilTest.check(checkSha256Request, value.sharedSecret));
            });
